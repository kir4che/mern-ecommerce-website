...
const getProducts = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, code: "PRODUCTS_FETCH_FAILED", message });
  }
};
...
const getProductById = async (req: Request<{ id: string }>, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, code: "PRODUCT_FETCH_FAILED", message });
  }
};
...
const addProduct = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, code: "PRODUCT_CREATE_FAILED", message });
  }
};
...
const updateProduct = async (req: Request<{ id: string }>, res: Response) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, code: "PRODUCT_UPDATE_FAILED", message });
  }
};
...
const deleteProductById = async (
  ...
  try {
    ...
    return res
      .status(500)
      .json({ success: false, code: "PRODUCT_DELETE_FAILED", message });
  }
};
