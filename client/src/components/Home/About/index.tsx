    ...
    <section className='relative pt-10 pb-16 overflow-hidden min-h-screenwithh'>
      ...
      <div className='relative px-[5vw] space-y-10 z-20 pt-[12vw] md:pt-[8vw] text-secondary'>
        ...
        <div className='flex flex-col justify-between gap-12 md:gap-0 md:items-end md:flex-row'>
          ...
          <Link to='/pages/about' className='flex items-center w-full gap-3 hover:underline md:justify-end'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" fill="none" viewBox="0 0 7 12">
              <path fill="#ffffff" fillRule="evenodd" d="M.353.353a.5.5 0 0 1 .708 0l5.553 5.554-5.553 5.553a.5.5 0 0 1-.708-.707L5.2 5.907.353 1.061a.5.5 0 0 1 0-.708Z" clipRule="evenodd" />
            </svg>
          </Link>
        </div>
      </div>
