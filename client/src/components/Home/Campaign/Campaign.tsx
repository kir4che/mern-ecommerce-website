        ...
        <div className='flex items-center gap-3'>
          ...
          <button onClick={() => swiperRef.current.slidePrev()}>
            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none" viewBox="0 0 6 10">
              <path fill="#081122" fillRule="evenodd" d="M0 4.772 4.419.353a.5.5 0 0 1 .707.707L1.414 4.772l3.712 3.711a.5.5 0 0 1-.707.707L0 4.772Z" clipRule="evenodd"></path>
            </svg>
          </button>
          <button onClick={() => swiperRef.current.slideNext()}>
            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none" viewBox="0 0 6 10">
              <path fill="#081122" fillRule="evenodd" d="M5.271 4.565.853 8.984a.5.5 0 1 1-.708-.708l3.712-3.711L.145.854A.5.5 0 1 1 .853.146L5.27 4.565Z" clipRule="evenodd"></path>
            </svg>
          </button>
        </div>
      </div>
