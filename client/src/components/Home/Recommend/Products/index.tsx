        ...
        [
          ...
          <SwiperSlide key={product.title}>
            <div className="recommend__item">
              <h3 className="space-y-0.5 px-2 w-fit bg-primary sm:text-lg z-10 relative mb-2.5 text-secondary">
                {product.title}
              </h3>
              <div className="flex z-10 relative gap-1.5">
                {product.categories.map((category, index) => (
                  <p
                    className="px-3 py-1 sm:py-0 sm:px-2 border sm:border-[0.875px] w-fit font-medium rounded-full text-sm sm:text-xxs bg-secondary border-primary"
                    key={index}
                  >
                    #{category}
                  </p>
              ...
              <Link
                ...
                className="block mb-4 -mt-12 recommend__item__img"
              >
                <img
              ...
              <div className="recommend__item__info">
                <div className="flex justify-between sm:items-center">
                  ...
                  <div className="flex flex-col items-center gap-2 md:flex-row">
                    ...
                    <button
                      className="px-5 py-2 text-sm duration-500 border rounded-full border-primary hover:text-primary hover:bg-secondary text-secondary sm:py-1 sm:px-2 sm:text-xs bg-primary"
