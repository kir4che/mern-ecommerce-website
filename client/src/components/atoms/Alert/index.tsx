...
const Alert: React.FC = () => {
  ...
  return (
    <div
      role="alert"
      className={`alert ${iconMap[variant].style} flex text-nowrap items-center rounded-md z-[9999] gap-2 border-none py-2.5  w-fit transition-opacity duration-500 font-medium ${floating ? `fixed -translate-x-1/2 left-1/2 ${top}` : ""}`}
    >
