  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto px-[12vw]">
        <h1 className="pt-12 pb-10 text-xl text-center md:text-base">
          登入會員
        </h1>
        {error !== "" && (
          <div
            className="flex items-center p-4 mb-4 -mt-6 text-sm text-red-700 rounded-lg bg-red-50"
            role="alert"
          >
            <svg
            ...
            <p>
              <span className="font-medium">登入失敗！</span>
              {error}
            </p>
          </div>
        )}
        <form className="flex flex-col gap-4 md:text-sm" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className="px-10 mt-4 -mb-2 py-2.5 mx-auto border border-secondary hover:border-primary text-secondary bg-primary w-fit"
          >
            登入
          </button>
          <Link
