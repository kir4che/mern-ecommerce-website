  ...
  const renderDialog = item => (
    <li className='flex items-center justify-between py-3 text-xs border-b border-gray-300 border-dashed cursor-pointer' key={item._id}>
      ...
      <div className='space-x-4'>
        ...
        {item.toString() === 'product' ? <ProductEditForm isAddOrEdit={isAddOrEditProductForm} setIsAddOrEdit={setIsAddOrEditProductForm} form={productForm} setForm={setProductForm} handleFormUpdate={handleFormUpdate} />
