        ...
        <div className='px-[5vw]'>
          ...
          <div className='flex flex-col w-full gap-8 sm:flex-row'>
            <section className='flex-1'>
                ...
                {products.map(product => (
                  <li className='flex items-center justify-between py-3 text-xs border-b border-gray-300 border-dashed cursor-pointer' key={product._id}>
                    ...
                    <div className='space-x-4'>
                      ...
                      <ProductEditForm isAddOrEdit={isAddOrEditProductForm} setIsAddOrEdit={setIsAddOrEditProductForm} form={productForm} setForm={setProductForm} handleFormUpdate={handleFormUpdate} />
              ...
              <button className='block mt-3 ml-auto text-sm w-fit text-secondary hover:text-primary hover:bg-secondary border-primary bg-primary btn-primary' onClick={() => {
                setProductForm({
                  _id: '',
                  title: '',
                  tagline: '',
