...
const Dashboard = () => {
  ...
  if (productLoading || postLoading || orderLoading) return <Loading />;
    ...
    return <Error message={[productError, postError, orderError]} />;
    ...
    if (todo === "add") {
      ...
      try {
        const res = await fetch(
          `${process.env.REACT_APP_API_URL}/${item}/${item === "products" ? productForm._id : postForm._id}`,
          {
            method: "PATCH",
            headers: {
              "Content-Type": "application/json",
                ...
                {posts.map((post) => (
                  ...
                  >
                    ...
                    <div className="space-x-4">
                      ...
                      <PostEditForm
                        isAddOrEdit={isAddOrEditPostForm}
                        setIsAddOrEdit={setIsAddOrEditPostForm}
                        form={postForm}
                        setForm={setPostForm}
                        handleFormUpdate={handleFormUpdate}
                      />
