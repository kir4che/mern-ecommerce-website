...
export const ERROR_CODE_MAP: Record<string, ErrorMapValue> = {
  // === 登入、註冊與權限 ===
  ...
  ORDER_CANCEL_FORBIDDEN: "您無法取消這筆訂單",
  ORDER_CANNOT_CANCEL: "只有未付款的訂單可以取消",
  ...
  COUPON_CREATE_FAILED: "新增優惠碼失敗，請稍後再試。",
